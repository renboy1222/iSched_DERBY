...
public class SemesterDAOImpl extends DBConnection implements SemesterDAO {
    ...
    public void addSemester(Semester semester) {
        try {
            getDBConn();
            java.sql.PreparedStatement ps = getCon().prepareStatement("INSERT INTO ALDRIN.SEMESTER (ID,SEMESTER) VALUES  (?,?) ");
    ...
    public void updateSemester(Semester semester) {
        try {
            getDBConn();
            java.sql.PreparedStatement ps = getCon().prepareStatement("UPDATE ALDRIN.SEMESTER SET SEMESTER =? WHERE SEMESTER.ID = ?");
    ...
    public void deleteSemester(Semester semester) {
        try {
            getDBConn();
            java.sql.PreparedStatement ps = getCon().prepareStatement("UPDATE ALDRIN.SEMESTER SET DELETED =? WHERE SEMESTER.ID = ? ");
    ...
    public ArrayList<Semester> selectSemester() {
        ...
        try {
            String query = "SELECT * FROM ALDRIN.SEMESTER WHERE SEMESTER.DELETED =FALSE  ORDER BY SEMESTER ASC ";
            getDBConn();
    ...
    public void comboBoxSemester() {
        ...
        try {
            ...
            ResultSet rs;
            statement = getCon().prepareStatement("SELECT * FROM ALDRIN.SEMESTER WHERE SEMESTER.DELETED =FALSE  ORDER BY SEMESTER ASC ");
