...
public class SubjectDAOImpl extends DBConnection implements SubjectDAO {
    ...
    public void addSubject(Subject subject) {
        try {
            getDBConn();
            java.sql.PreparedStatement ps = getCon().prepareStatement("INSERT INTO ALDRIN.SUBJECT (ID,SUBJECT,UNITS) VALUES  (?,?,?) ");
    ...
    public void updateSubject(Subject subject) {
        try {
            getDBConn();
            java.sql.PreparedStatement ps = getCon().prepareStatement("UPDATE ALDRIN.SUBJECT SET  SUBJECT =?, UNITS=? WHERE SUBJECT.ID = ?");
    ...
    public void deleteSubject(Subject subject) {
        try {
            getDBConn();
            java.sql.PreparedStatement ps = getCon().prepareStatement("UPDATE ALDRIN.SUBJECT SET DELETED =? WHERE SUBJECT.ID = ? ");
    ...
    public ArrayList<Subject> selectSubject() {
        ...
        try {
            String query = "SELECT * FROM ALDRIN.SUBJECT WHERE SUBJECT.DELETED =FALSE  ORDER BY SUBJECT ASC ";
            getDBConn();
    ...
    public void comboBoxSubject() {
        ...
        try {
            ...
            ResultSet rs;
            statement = getCon().prepareStatement("SELECT * FROM ALDRIN.SUBJECT WHERE SUBJECT.DELETED =FALSE  ORDER BY SUBJECT ASC ");
